const AUDIO_CDN_BASE_URL = import.meta.env.VITE_AUDIO_CDN_URL || "https://cdn.jsdelivr.net/gh/soumya2611/mobus-musicplayer@audio-v1";
...
export const playlist = [
  ...
  {
    id: 3,
    title: "मेरा दिल भी कितना पागल है",
  ...
  {
    id: 6,
    title: "राह में उनसे मुलाक़ात हो गई",
  ...
  {
    id: 7,
    title: "तू धरती पे चाहे जहाँ भी रहेगी",
  ...
  {
    id: 8,
    title: "मौका मिलेगा तो हम बता देंगे",
  ...
  {
    id: 12,
    title: "आपके प्यार में हम सवरने लगे",
  ...
  {
    id: 15,
    title: "बहुत प्यार करते हैं तुमको सनम",
  ...
  {
    id: 16,
    title: "ଦୀପଟିଏ ମୋତେ କରିଦିଅ ପ୍ରଭୁ",
  ...
  {
    id: 20,
    title: "ଜଗତରେ ପାଇବନି ଏମିତି ଠାକୁର",
  ...
  {
    id: 21,
    title: "जीये तो जीये कैसे बिन आपके",
  ...
  {
    id: 25,
    title: "मेरी तरह तुम भी कभी प्यार करके देखो",
  ...
  {
    id: 26,
    title: "मुबारक हो तुमको ये शादी तुम्हारी",
...
export const BUS_ROUTES = [
  {
    id: 1,
    busModel: 'mobus', // Odisha Green & Blue Mo Bus
    routeNo: "OD-02 Superfast",
    orFrom: "ଭୁବନେଶ୍ୱର", orTo: "ସମ୍ବଲପୁର",
    hiFrom: "भुवनेश्वर", hiTo: "संबलपुर",
    enFrom: "Bhubaneswar", enTo: "Sambalpur",
    distanceKm: 50
  },
  {
    id: 2,
    busModel: 'classic', // Classic Red & Yellow Roadways Express
    routeNo: "NH-44 Express",
    orFrom: "ଦିଲ୍ଲୀ", orTo: "ମନାଲି",
    hiFrom: "दिल्ली", hiTo: "मनाली",
    enFrom: "Delhi", enTo: "Manali",
    distanceKm: 120
  },
  {
    id: 3,
    busModel: 'deluxe', // Deluxe Orange & Cyan Sleeper Volvo
    routeNo: "OD-13 Deluxe",
    orFrom: "ପୁରୀ", orTo: "ରାଉରକେଲା",
    hiFrom: "पुरी", hiTo: "राउरकेला",
    enFrom: "Puri", enTo: "Rourkela",
    distanceKm: 80
  },
  {
    id: 4,
    busModel: 'mobus', // Odisha Mo Bus
    routeNo: "OD-04 Express",
    orFrom: "ଭଦ୍ରକ", orTo: "କଟକ",
    hiFrom: "भद्रक", hiTo: "कटक",
    enFrom: "Bhadrak", enTo: "Cuttack",
    distanceKm: 30
  },
  {
    id: 5,
    busModel: 'classic', // Classic Roadways
    routeNo: "RJ-14 Deluxe",
    orFrom: "ଜୟପୁର", orTo: "ଉଦୟପୁର",
    hiFrom: "जयपुर", hiTo: "उदयपुर",
    enFrom: "Jaipur", enTo: "Udaipur",
    distanceKm: 90
  },
  {
    id: 6,
    busModel: 'deluxe', // Deluxe Volvo
    routeNo: "OD-07 Night King",
    orFrom: "ବ୍ରହ୍ମପୁର", orTo: "ବାରିପଦା",
    hiFrom: "ब्रह्मपुर", hiTo: "बारीपदा",
    enFrom: "Berhampur", enTo: "Baripada",
    distanceKm: 110
  }
];
